...
import permission.rom.OppoUtils;
...
public class FloatWindowUtil {
    ...
    public void applyFloatWindow(Context context) {
        if (checkPermission(context)) {
            Toast.makeText(context , "Float Window Permission Success!", Toast.LENGTH_SHORT).show();
        } else {
    ...
    private void ROM360PermissionApply(final Context context) {
        showConfirmDialog(context, new FloatWindowUtil.OnConfirmResult() {
            @Override
    ...
    private void showConfirmDialog(Context context, FloatWindowUtil.OnConfirmResult result) {
        showConfirmDialog(context, "您的手机没有授予悬浮窗权限，请开启后再试", result);
    }

    private void showConfirmDialog(Context context, String message, final FloatWindowUtil.OnConfirmResult result) {
