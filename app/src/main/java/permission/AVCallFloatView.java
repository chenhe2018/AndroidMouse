...
public class AVCallFloatView extends FrameLayout {
    ...
    private void initView() {
        ...
        View floatView = inflater.inflate(R.layout.float_layout, null);

//        //添加浮动窗口按钮
//        ImageView imageView =(ImageView) floatView.findViewById(R.id.imageview);
...
//                    anchorToSide();
//                }
                Toast.makeText(getContext(), "this float window is touched", Toast.LENGTH_SHORT).show();
                break;
            default:
                break;
        }
